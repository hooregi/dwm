...
static Key keys[] = {
  ...
  { MODKEY, XK_p, spawn, SHCMD("playerctl -p ncspot,mpv,%any play-pause") },
  { MODKEY, XK_comma, spawn, SHCMD("playerctl -p ncspot,mpv,%any previous") },
  { MODKEY, XK_period, spawn, SHCMD("playerctl -p ncspot,mpv,%any next") },
/*{ MODKEY,	XK_bracketright, spawn,SHCMD("playerctl -p ncspot,mpv,%any position +10") },
	{ MODKEY|ShiftMask, XK_bracketright, spawn,	SHCMD("playerctl -p ncspot,mpv,%any position +60") },
	{ MODKEY,	XK_bracketleft,	spawn, SHCMD("playerctl -p ncspot,mpv,%any position -10") },
	{ MODKEY|ShiftMask, XK_bracketleft,	spawn, SHCMD("playerctl -p ncspot,mpv,%any position -60") },*/
	{ 0, XF86XK_AudioPlay, spawn, SHCMD("playerctl -p ncspot,mpv,%any play-pause") },
	{ 0, XF86XK_AudioPause, spawn,SHCMD("playerctl -p ncspot,mpv,%any play-pause") },
